...
var CustomRangeDataFilter = function () {
    ...
    location.href = "/PaymentManual/Index?StartDate= " + _StartDate + "&EndDate= " + _EndDate;
};


var LoadDataTables = function () {
    document.title = 'Payment Manual';

    $("#tblPaymentsManual").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/PaymentManual/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        },
        {
            ...
            render: function (data, type, row) {
                if (row.DueAmount == 0 && row.GrandTotal > 0) {
                    ...
                    return "<a href='#' class='btn btn-info btn-xs' onclick=AddEditManual('" + row.Id + "');>Edit</a>";
                }
            }
        },
        {
