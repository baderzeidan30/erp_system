$(document).ready(function () {
    PurchasesSummarReportDataTableLoad(false, 0);
});


var PurchasesSummarReportDataTableLoad = function (_IsFilterData, _BranchId) {
    document.title = 'Purchases Summary Report';

    $("#tblPurchasesSummaryReport").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        ajax: {
            url: "/PurchasesReport/GetDataTablePurchasesSummaryList?IsFilterData=" + _IsFilterData + "&BranchId= " + _BranchId,
            type: "POST",
            datatype: "json",
        },
