...
var CustomRangeDataFilter = function () {
    ...
    location.href = "/PurchasesPayment/Index?StartDate= " + _StartDate + "&EndDate= " + _EndDate;
};

var LoadDataTables = function () {
    document.title = 'Purchases Payment';

    $("#tblPurchasesPayment").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/PurchasesPayment/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        },
        {
            ...
            "name": "SupplierId",
            render: function (data, type, row) {
                return "<a href='#' onclick=ViewSupplierDetails('" + row.SupplierId + "');>" + row.SupplierName + "</a>";
            }
        },
        ...
        },
        {
            data: "Id", "name": "Id", render: function (data, type, row) {
                return "<a href='#' class='btn btn-sm btn-primary' onclick=GetPurchaseRetrurn('" + row.Id + "');><i class='fa fa-arrow-circle-left' aria-hidden='true'></i></a>";
            }
        },
        {
            data: null,
