$(document).ready(function() {
    document.title = 'Purchases Payment Quote';

    $("#tblPurchasesPaymentQuote").DataTable({
        paging: true,
        select: true,
        "order": [
            [0, "desc"]
        ...
        "ajax": {
            "url": "/PurchasesPaymentQuote/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [{
                ...
                render: function(data, type, row) {
                    return "<a href='#' onclick=Details('" + row.Id + "');>" + row.QuoteNo + "</a>";
                }
            },
            {
                data: "SupplierId",
