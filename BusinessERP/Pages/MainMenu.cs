namespace BusinessERP.Pages
{
    public static class MainMenu
    {
        ...
        public static class ManageUserRoles
        {
            ...
            public const string ControllerName = "ManageUserRoles";
            public const string ActionName = "Index";
        }
        public static class SystemRole
        {
            ...
            public const string ControllerName = "SystemRole";
            public const string ActionName = "Index";
        }
        ...
        //Sales Pro
        public static class BusinessERP
        {
            public const string PageName = "Business ERP";
            public const string RoleName = "Business ERP";
            public const string Path = "/BusinessERP/Index";
            public const string ControllerName = "BusinessERP";
            public const string ActionName = "Index";
        }

        public static class ManageInvoice
        {
            public const string PageName = "Manage Sales";
            public const string RoleName = "Manage Invoice";
        }
        ...
        {
            public const string PageNameRoot = "Manual Invoice";
            public const string PageName = "Manual Invoice";
            public const string RoleName = "Manual Invoice";
            public const string Path = "/PaymentManual/Index";
            public const string ControllerName = "PaymentManual";
            public const string ActionName = "Index";
        }
        public static class DraftInvoice
        {
            public const string PageName = "Draft Invoice";
            public const string RoleName = "Draft Invoice";
            public const string Path = "/PaymentDraft/Index";
            public const string ControllerName = "PaymentDraft";
            public const string ActionName = "Index";
        }
        public static class QuoteInvoice
        {
            public const string PageName = "Quote Invoice";
            public const string RoleName = "Quote Invoice";
            public const string Path = "/PaymentQuote/Index";
            public const string ControllerName = "PaymentQuote";
            public const string ActionName = "Index";
        }
        public static class PurchasesPayment
        {
            public const string PageName = "Purchases Invoice";
            public const string RoleName = "Purchases Payment";
            public const string Path = "/PurchasesPayment/Index";
            public const string ControllerName = "PurchasesPayment";
            public const string ActionName = "Index";
        }
        public static class PurchasesPaymentDraft
        {
            public const string PageName = "Purchases Invoice Draft";
            public const string RoleName = "Purchases Payment Draft";
            public const string Path = "/PurchasesPaymentDraft/Index";
            public const string ControllerName = "PurchasesPaymentDraft";
            public const string ActionName = "Index";
        }
        public static class PurchasesPaymentQuote
        {
            public const string PageName = "Purchases Invoice Quote";
            public const string RoleName = "Purchases Payment Quote";
            public const string Path = "/PurchasesPaymentQuote/Index";
            public const string ControllerName = "PurchasesPaymentQuote";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "Expense";
            public const string RoleName = "Expense";           
        }
        public static class ExpenseType
        {
            public const string PageName = "Expense Type";
            public const string RoleName = "Expense Type";
            public const string Path = "/ExpenseType/Index";
            public const string ControllerName = "ExpenseType";
            public const string ActionName = "Index";
        }
        public static class ExpenseSummary
        {
            public const string PageName = "Expense Summary";
            public const string RoleName = "Expense Summary";
            public const string Path = "/ExpenseSummary/Index";
            public const string ControllerName = "ExpenseSummary";
            public const string ActionName = "Index";
        }
        ...
        public static class PurchaseReturnLog
        {
            public const string PageName = "Purchase Return Log";
            public const string RoleName = "Purchase Return Log";
            public const string Path = "/ReturnLog/PurchaseReturnIndex";
            public const string ControllerName = "ReturnLog";
            public const string ActionName = "PurchaseReturnIndex";
        }
        ...
        {
            public const string PageName = "Item Request";
            public const string RoleName = "Item Request";
            public const string Path = "/ItemRequest/Index";
            public const string ControllerName = "ItemRequest";
            public const string ActionName = "Index";
        }
        public static class ItemTransferLog
        {
            public const string PageName = "Item Transfer Log";
            public const string RoleName = "Item Transfer Log";
            public const string Path = "/ItemTransferLog/Index";
            public const string ControllerName = "ItemTransferLog";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "Customer Info";
        ...
        public static class WarehouseWiseItems
        {
            public const string PageName = "Warehouse Wise Items";
            public const string RoleName = "Warehouse Wise Items";
            public const string Path = "/WarehouseWiseItems/Index";
            public const string ControllerName = "WarehouseWiseItems";
            public const string ActionName = "Index";
        }
        public static class WarehouseNotification
        {
            public const string PageName = "Warehouse Notification";
            public const string RoleName = "Warehouse Notification";
            public const string Path = "/WarehouseNotification/Index";
            public const string ControllerName = "WarehouseNotification";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "Customer Sales Report";
            public const string Path = "/CustomerSalesReport/Index";
            public const string ControllerName = "CustomerSalesReport";
            public const string ActionName = "Index";         
        }
        ...
        //Purchases Report
        public static class PurchasesReport
        {
            public const string PageName = "Purchases Report";
            public const string RoleName = "Purchases Report";           
        }
        public static class PurchasesSummary
        {
            public const string PageName = "Purchases Summary";
            public const string RoleName = "Purchases Summary";
            public const string Path = "/PurchasesReport/PurchasesSummary";
            public const string ControllerName = "PurchasesReport";
            public const string ActionName = "PurchasesSummary";
        }
        public static class PurchasesDetail
        {
            public const string PageName = "Purchases Detail";
            public const string RoleName = "Purchases Detail";
            public const string Path = "/PurchasesReport/PurchasesDetail";
            public const string ControllerName = "PurchasesReport";
            public const string ActionName = "PurchasesDetail";
        }
        public static class PurchasesTransactionByDay
        {
            public const string PageName = "Transaction By Day";
            public const string RoleName = "Purchases Transaction By Day";
            public const string Path = "/PurchasesReport/PurchasesTransactionByDay";
            public const string ControllerName = "PurchasesReport";
            public const string ActionName = "PurchasesTransactionByDay";
        }
        public static class PurchasesTransactionByMonth
        {
            public const string PageName = "Transaction By Month";
            public const string RoleName = "Purchases Transaction By Month";
            public const string Path = "/PurchasesReport/PurchasesTransactionByMonth";
            public const string ControllerName = "PurchasesReport";
            public const string ActionName = "PurchasesTransactionByMonth";
        }
        public static class PurchasesTransactionByYear
        {
            public const string PageName = "Transaction By Year";
            public const string RoleName = "Purchases Transaction By Year";
            public const string Path = "/PurchasesReport/PurchasesTransactionByYear";
            public const string ControllerName = "PurchasesReport";
            public const string ActionName = "PurchasesTransactionByYear";
        }
        ...
        {
            public const string PageName = "Summary Report";
            public const string RoleName = "Summary Report";
            public const string Path = "/SalesReport/SummaryReport";
            public const string ControllerName = "SalesReport";
            public const string ActionName = "SummaryReport";
        }
        ...
        {
            public const string PageName = "Attendance Report";
            public const string RoleName = "Attendance Report";
            public const string Path = "/SalesReport/AttendanceReport";
            public const string ControllerName = "SalesReport";
            public const string ActionName = "AttendanceReport";
        }
        ...
        {
            public const string PageName = "Manage Employee";
        ...
        public static class Designation
        {
            ...
            public const string ControllerName = "Designation";
            public const string ActionName = "Index";
        } 
        ...
        public static class SubDepartment
        {
            ...
            public const string ControllerName = "SubDepartment";
            public const string ActionName = "Index";
        }
        public static class Attendance
        {
            public const string PageName = "Attendance";
            public const string RoleName = "Attendance";
            public const string Path = "/Attendance/Index";
        ...
        {
            public const string PageName = "Expense Report";
            public const string RoleName = "Expense Report";           
        }
        public static class ExpenseSummaryReport
        {
            public const string PageName = "Expense Summary";
            public const string RoleName = "Expense Summary Report";
            public const string Path = "/ExpenseReport/ExpenseSummaryReport";
            public const string ControllerName = "ExpenseReport";
            public const string ActionName = "ExpenseSummaryReport";
        }
        public static class ExpenseDetailsReport
        {
            public const string PageName = "Expense Details";
            public const string RoleName = "Expense Details Report";
            public const string Path = "/ExpenseReport/ExpenseDetailsReport";
            public const string ControllerName = "ExpenseReport";
            public const string ActionName = "ExpenseDetailsReport";
        }
        public static class ExpenseByDay
        {
            public const string PageName = "Expense By Day";
            public const string RoleName = "Expense Report By Day";
            public const string Path = "/ExpenseReport/ExpenseByDay";
            public const string ControllerName = "ExpenseReport";
            public const string ActionName = "ExpenseByDay";
        }
        public static class ExpenseByMonth
        {
            public const string PageName = "Expense By Month";
            public const string RoleName = "Expense Report By Month";
            public const string Path = "/ExpenseReport/ExpenseByMonth";
            public const string ControllerName = "ExpenseReport";
            public const string ActionName = "ExpenseByMonth";
        }
        public static class ExpenseByYear
        {
            public const string PageName = "Expense By Year";
            public const string RoleName = "Expense Report By Year";
            public const string Path = "/ExpenseReport/ExpenseByYear";
            public const string ControllerName = "ExpenseReport";
            public const string ActionName = "ExpenseByYear";
        }

        public static class StockItemReport
        {
            public const string PageName = "Stock Item Report";
            public const string Path = "/StockItemReport/Index";
            public const string ControllerName = "StockItemReport";
            public const string ActionName = "Index";         
        }
        public static class SystemSettings
        {
            public const string PageName = "System Settings";
            public const string Path = "/SystemSettings/Index";
            public const string ControllerName = "SystemSettings";
            public const string ActionName = "Index";         
        }
        ...
        {
            public const string PageName = "Income Summary";
            public const string RoleName = "Income Summary";
            public const string Path = "/IncomeSummary/Index";
            public const string ControllerName = "IncomeSummary";
        }
        public static class IncomeType
        {
            public const string PageName = "Income Type";
            public const string RoleName = "Income Type";
            public const string Path = "/IncomeType/Index";
            public const string ControllerName = "IncomeType";
        }
        public static class IncomeCategory
        {
            public const string PageName = "Income Category";
            public const string RoleName = "Income Category";
            public const string Path = "/IncomeCategory/Index";
            public const string ControllerName = "IncomeCategory";
        }
        public static class IncomeSummaryReport
        {
            public const string PageName = "Income Summary Report";
            public const string Path = "/IncomeSummaryReport/Index";
            public const string ControllerName = "IncomeSummaryReport";
        }

        //Accounting Module
        public static class AccAccount
        {
            public const string PageName = "Account";
            public const string RoleName = "Acc Account";
            public const string Path = "/AccAccount/Index";
            public const string ControllerName = "AccAccount";
        }
        public static class AccDeposit
        {
            public const string PageName = "Deposit";
            public const string RoleName = "Acc Deposit";
            public const string Path = "/AccDeposit/Index";
            public const string ControllerName = "AccDeposit";
        }
        public static class AccExpense
        {
            public const string PageName = "Expense";
            public const string RoleName = "Acc Expense";
            public const string Path = "/AccExpense/Index";
            public const string ControllerName = "AccExpense";
        }
        public static class AccTransfer
        {
            public const string PageName = "Transfer";
            public const string RoleName = "Acc Transfer";
            public const string Path = "/AccTransfer/Index";
            public const string ControllerName = "AccTransfer";
        }
        public static class AccTransaction
        {
            public const string PageName = "Transaction";
            public const string RoleName = "Acc Transaction";
            public const string Path = "/AccTransaction/Index";
            public const string ControllerName = "AccTransaction";
        }
    }
}
