...
namespace BusinessERP.Helpers
{
    public static class StaticData
    {
        ...
        public static string CompanyType(Int64 _Type)
        {
            string[] _TypeDisplay = { "Other", "Trader", "Premium", "Normal" };
            return _TypeDisplay[_Type];
        }
        public static string GetRequestStatus(RequestStatus _RequestStatus)
        {
            if (_RequestStatus == RequestStatus.New)
                return "New";
            else if (_RequestStatus == RequestStatus.Pending)
                return "Pending";
            else if (_RequestStatus == RequestStatus.Send)
                return "Send";
            else if (_RequestStatus == RequestStatus.Rejected)
                return "Rejected";
            else if (_RequestStatus == RequestStatus.ItemNotAvailable)
                return "Item Not Available";
            else
                return "New";
        }
        public static string GetSizeDisplay(int Size)
        {
            if (Size == 12)
                return "Bag";
            else if (Size == 25)
        ...
        public static DateTime StartOfDay(this DateTime _DateTime)
        {
        ...
        public static string ReplaceSpecialCharacters(string fileName)
        {
            ...
            string cleanedName = Regex.Replace(nameWithoutExtension, pattern, "_");
    ...
    public static class InvoiceType
    {
        ...
        public const int ManualInvoice = 4;
    }
    ...
    public static class InvoicePaymentType
    {
        ...
        public const int RegularExpensePayment = 3;
    }
    ...
    public static class AccAccountUpdateType
    {
        public const int Credit = 1;
        public const int CreditRevart = 2;
        public const int Debit = 3;
        public const int DebitRevart = 4;
    }
    public static class AccAccountInfo
    {
        public const int DefaultAccount = 1;
    }
