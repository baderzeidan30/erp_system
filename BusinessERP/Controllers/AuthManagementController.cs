...
using BusinessERP.JWTConfiguration;
using BusinessERP.JWTConfiguration.DTOs.Requests;
using BusinessERP.JWTConfiguration.DTOs.Responses;
...
namespace BusinessERP.Controllers
{
    ...
    public class AuthManagementController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("Register")]
        public async Task<IActionResult> Register([FromBody] UserProfileCRUDViewModel _UserProfileViewModel)
        {
