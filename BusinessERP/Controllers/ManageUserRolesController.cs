...
namespace BusinessERP.Controllers
{
    ...
    public class ManageUserRolesController : Controller
    {
        ...
        public async Task<IActionResult> Details(Int64 id)
        {
            ...
            vm.listManageUserRolesViewModel = await _iCommon.GetManageRoleDetailsList(id);
        ...
        public async Task<IActionResult> AddEdit(Int64 id)
        {
            ...
            if (id > 0)
            {
                vm = await _context.ManageUserRoles.Where(x => x.Id == id).FirstOrDefaultAsync();
                vm.listManageUserRolesViewModel = await _iCommon.GetManageRoleDetailsList(id);
            }
            else
            {
                vm.listManageUserRolesViewModel = await _roles.GetRoleList();
            }
        ...
        public async Task<IActionResult> AddEdit(ManageUserRolesCRUDViewModel vm)
        {
            try
            {
                ...
                if (vm.Id > 0)
                {
                    ...
                    foreach (var item in vm.listManageUserRolesViewModel)
                    {
        ...
        public async Task<IActionResult> UpdateUserRole(Int64 id)
        {
            ...
            vm.listManageUserRolesViewModel = await _roles.GetRolesByUser(_GetRolesByUserViewModel);
